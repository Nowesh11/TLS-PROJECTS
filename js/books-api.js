...
class BooksAPI {
    ...
    transformBookData(apiBooks) {
        return apiBooks.map(book => ({
            ...
            tamilTitle: book.titleTamil || book.title || "தலைப்பு இல்லை",
            author: book.author || "Unknown Author",
            authorTamil: book.authorTamil || book.author || "எழுத்தாளர் தெரியவில்லை",
    ...
    transformEbookData(apiEbooks) {
        return apiEbooks.map(ebook => ({
            ...
            tamilTitle: ebook.titleTamil || ebook.title || "தலைப்பு இல்லை",
            author: ebook.author || "Unknown Author",
            authorTamil: ebook.authorTamil || ebook.author || "எழுத்தாளர் தெரியவில்லை",
    ...
    transformProjectData(apiProjects) {
        return apiProjects.map(project => ({
            ...
            tamilTitle: project.titleTamil || project.title || "திட்டம்",
