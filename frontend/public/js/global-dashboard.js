                ...
                datasets: [
                    {
                        ...
                        backgroundColor: "var(--bg-accent-pink, rgba(236, 72, 153, 0.1))",
                        tension: 0.4,
                        fill: true
                    },
                    {
                        ...
                        backgroundColor: "var(--bg-success, rgba(34, 197, 94, 0.1))",
                        tension: 0.4,
                        fill: true
                    },
                    {
                        ...
                        backgroundColor: "var(--bg-primary, rgba(59, 130, 246, 0.1))",
                        tension: 0.4,
                        fill: true
                    }
                ]
