...
class ContentEditor {
    ...
    // Image upload functionality removed - only logo uploads are supported
    // Use uploadGlobalLogo() function for logo uploads only
    ...
    selectImage(element, fieldName) {
        ...
        input.onchange = (e) => {
            ...
            if (file) {
                // Image upload functionality removed - only logo uploads supported
                console.log('Image upload functionality has been removed');
            }
        };
        input.click();
    }

    // Image upload functionality removed - only logo uploads supported via uploadGlobalLogo()
    ...
    // Image upload with validation functionality removed - only logo uploads supported via uploadGlobalLogo()
    ...
    async processImageUpload(file, sectionKey, containerElement) {
        try {
            ...
            // Image upload functionality removed - only logo uploads supported
            console.log('Image upload functionality has been removed');
            containerElement.innerHTML = originalContent; // Restore original content
