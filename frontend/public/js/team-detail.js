    ...
    updateLanguageButtons() {
        ...
        langButtons.forEach(btn => {
            ...
            if ((btn.textContent === 'EN' && this.currentLanguage === 'en') ||
                (btn.textContent === 'Tamil' && this.currentLanguage === 'ta')) {
                ...
                <div class="member-info">
                    <div class="info-section">
                        <h3>
                            ...
                            <span data-key="about_title" data-content-type="text">About</span>
                        </h3>
                        <p class="bio-text">${displayBio || '<span data-key="no_biography" data-content-type="text">No biography available.</span>'}</p>
                    </div>
                    
                    <div class="info-section">
                        <h3>
                            <i class="fas fa-address-book"></i>
                            <span data-key="contact_information" data-content-type="text">Contact Information</span>
                        </h3>
