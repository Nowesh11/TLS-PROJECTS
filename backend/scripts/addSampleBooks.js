...
const sampleBooks = [
    {
        ...
        pages: 450,
        bookLanguage: "Tamil",
        coverImage: "/assets/book-covers/tamil-classics.jpg",
        inStock: true,
        stockQuantity: 50,
        featured: true,
        bestseller: true,
    ...
    },
    {
        ...
        pages: 280,
        bookLanguage: "Tamil",
        coverImage: "/assets/book-covers/modern-poetry.jpg",
        inStock: true,
        stockQuantity: 30,
        featured: true,
        bestseller: false,
    ...
    },
    {
        ...
        pages: 520,
        bookLanguage: "Tamil",
        coverImage: "/assets/book-covers/cultural-heritage.jpg",
        inStock: true,
        stockQuantity: 25,
        featured: false,
        bestseller: true,
    ...
    {
        title: "Tamil Language Evolution",
        titleTamil: "தமிழ் மொழி வளர்ச்சி",
        author: "Dr. Suresh Babu",
        authorTamil: "டாக்டர் சுரேஷ் பாபு",
        description: "A scholarly study of the evolution and development of the Tamil language through the ages.",
        descriptionTamil: "காலங்கள் வழியாக தமிழ் மொழியின் பரிணாமம் மற்றும் வளர்ச்சியின் அறிவார்ந்த ஆய்வு.",
        category: "language",
        price: 399,
        originalPrice: 499,
        isbn: "978-81-123-4568-1",
        publisher: "Linguistic Research Institute",
        publishedDate: new Date("2023-08-05"),
        pages: 680,
        bookLanguage: "Tamil",
        coverImage: "/assets/book-covers/language-evolution.jpg",
        inStock: true,
        stockQuantity: 20,
        featured: true,
        bestseller: false,
        ...
        rating: 4.6,
        reviewCount: 15,
        tags: ["language", "linguistics", "evolution", "research"],
        status: "active"
    },
    {
        ...
        pages: 120,
        bookLanguage: "Tamil",
        coverImage: "/assets/book-covers/children-stories.jpg",
        inStock: true,
        stockQuantity: 100,
        featured: true,
        bestseller: true,
...
async function addSampleBooks() {
    try {
        ...
        if (existingBooks.length > 0) {
            console.log(`${existingBooks.length} books already exist in the database.`);
        ...
        console.log(`Successfully added ${insertedBooks.length} sample books:`);
